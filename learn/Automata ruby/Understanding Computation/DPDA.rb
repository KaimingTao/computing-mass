...
if defined? PDARule
  Object.send(:remove_const, :PDARule)
end
...
class DPDARulebook < Struct.new(:rules)
  ...
  def rule_for(configuration, character)
    rules.detect {|rule| rule.apply_to?(configuration, character) }
  end
end
...
if defined? DPDADesign
  Object.send(:remove_const, :DPDADesign)
end
